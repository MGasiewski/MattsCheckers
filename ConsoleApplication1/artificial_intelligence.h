...
public:
	...
	int score_move(vector<int> move, vector<vector<int>> board_matrix, int depth, bool max);
	vector<vector<int>> execute_move(vector<int> move, vector<vector<int>> board_matrix);
